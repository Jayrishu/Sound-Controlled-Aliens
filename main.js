function start(){
    ...
    classifier = ml5.soundClassifier("https://teachablemachine.withgoogle.com/models/blTomLf1Q/model.json", modelReady);
}
function modelReady(){
...
function gotResults(error, results){
    if (error) {
        ...
        if (results[0].label== "Background Noise") {
            ...
            img3.src = "aliens-03.png"
            img4.src = "aliens-04.png" 
        }else if (results[0].label== "Mobile Notification"){
            img1.src = "aliens-01.png"
            img2.src = "aliens-02.png"
